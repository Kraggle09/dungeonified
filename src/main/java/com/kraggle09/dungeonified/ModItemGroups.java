    ...
    public static final ItemGroup DUNGEONIFIED_GROUP = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().icon(() -> new ItemStack(ModBlocks.RUNESTONE_BRICKS))
                    ...
                    .entries((displayContext, entries) -> {
                        ...
                        entries.add(ModBlocks.RUNESTONE_WALL);
                        ...
                        entries.add(ModBlocks.POLISHED_RUNESTONE_WALL);
                        ...
                        entries.add(ModBlocks.PATTERNED_RUNESTONE_WALL);
                        ...
                        entries.add(ModBlocks.RUNESTONE_BRICK_WALL);
                        ...
                        entries.add(ModBlocks.SQUARED_RUNESTONE_BRICK_WALL);
                        ...
                        entries.add(ModBlocks.STONE_QUARTZ_WALL);
                        ...
                        entries.add(ModBlocks.STONE_QUARTZ_BRICK_WALL);
